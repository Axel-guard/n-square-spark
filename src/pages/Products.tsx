...
import { ArrowRight, Bus, Car, Zap, Building2, GraduationCap, Factory, Lightbulb, Monitor, ShieldCheck } from "lucide-react";
...
const automotiveProducts = [
  {
    image: busLedLight,
    title: "BUS LED Light",
    description: "High-brightness LED tail lights and indicator lights designed for buses and commercial vehicles with IP67 waterproof rating.",
  },
  {
    image: bmsEv,
    title: "BMS for Electric Vehicle",
    description: "Advanced Battery Management System for EVs with real-time monitoring, cell balancing, and thermal management capabilities.",
  },
  {
    image: micAssembly,
    title: "MIC Assembly for Bus",
    description: "Multi-tone public address and siren system with microphone assembly for buses, featuring horn, wail, and siren modes.",
  },
];
...
const embeddedProducts = [
  {
    image: doorInterlock,
    title: "Inter Door Locking System",
    description: "Electromagnetic door interlock system for clean rooms ensuring only one door opens at a time, maintaining air pressure integrity.",
  },
  {
    image: homeAutomation,
    title: "Home Automation (Lighting Solutions)",
    description: "Smart lighting control system with Wi-Fi connectivity, scheduling, and remote control for residential and commercial spaces.",
  },
  {
    image: waterSoftener,
    title: "Water Softener Control System",
    description: "Programmable electronic control valve for water softeners with timer-based regeneration and service cycle management.",
  },
  {
    image: routeDisplay,
    title: "Digital Route Display System",
    description: "LED scrolling destination display board for buses with remote programming, GPS integration, and multilingual support.",
  },
];
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                End-to-end electronics solutions for automotive, embedded systems, industrial automation, and display technologies.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 section-light">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div>
                <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground">Automotive Solutions</h2>
                <p className="text-muted-foreground text-sm">Vehicle electronics, BMS, and transport systems</p>
              </div>
            </motion.div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7">
              {automotiveProducts.map((p, i) => (
                <SolutionCard key={i} {...p} />
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div>
                <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground">Embedded & Automation Solutions</h2>
                <p className="text-muted-foreground text-sm">Smart systems for industrial and residential applications</p>
              </div>
            </motion.div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-7">
              {embeddedProducts.map((p, i) => (
                <SolutionCard key={i} {...p} />
              ))}
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {industries.map((ind, i) => (
                <motion.div
                  key={ind.title}
                  className="bg-card border border-border rounded-2xl p-6 flex items-start gap-4 shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-300"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-muted-foreground mt-4 max-w-lg mx-auto">
                Real-world installations and deployments across India.
              </p>
            </motion.div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {galleryImages.map((img, i) => (
                <motion.div
                  key={i}
                  className="relative group rounded-2xl overflow-hidden aspect-[4/3] bg-muted"
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-foreground/0 group-hover:bg-foreground/40 transition-colors duration-300 flex items-end p-4">
                    <p className="text-card font-semibold text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      {img.alt}
                    </p>
                  </div>
                </motion.div>
